  ...
  return (
    ...
    <div className="form">
      ...
      <form action="">
        ...
        <p>Cà phê mang mọi người lại gần nhau và sự hiện diện trực tuyến của chúng tôi cũng vậy. Theo dõi chúng tôi trên các nền tảng truyền thông xã hội để luôn cập nhật các loại bia, chương trình khuyến mãi và sự kiện cộng đồng mới nhất. Giờ nghỉ giải lao ảo của bạn chỉ là một cú nhấp chuột.
</p>
    </div>
    </>
  );
